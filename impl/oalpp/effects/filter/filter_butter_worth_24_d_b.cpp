#include "filter_butter_worth_24_d_b.hpp"
#include <math.h>
...
FilterButterworth24db::FilterButterworth24db(void)
{
    this->history1 = 0.f;
    this->history2 = 0.f;
    this->history3 = 0.f;
...
void FilterButterworth24db::setSampleRate(float fs)
{
...
void FilterButterworth24db::set(float cutoff, float q)
{
