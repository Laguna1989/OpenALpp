...
std::array S_STILSON_GAINTABLE { 0.999969f, 0.990082f, 0.980347f, 0.970764f, 0.961304f, 0.951996f,
...
{
    auto const x1 = std::abs(sample + 0.95f);
    auto const x2 = std::abs(sample - 0.95f);
    return 0.5f * (x1 - x2);
}
