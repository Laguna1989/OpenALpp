#ifndef OPENALTRYOUT_LOW_LEVEL_FRICKEL_HPP
#define OPENALTRYOUT_LOW_LEVEL_FRICKEL_HPP
...
bool check_alc_errors(
    const std::string& filename, const std::uint_fast32_t line, ALCdevice* device);
...
#endif // OPENALTRYOUT_LOW_LEVEL_FRICKEL_HPP
